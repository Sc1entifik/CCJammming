...
export default async function ConnectSpotifyAccountMessage() {
	...
	const selectCurrentPlaylistMessage = cookieStore.has("auth") ? <Link className="text-textColor hover:text-sky-300" href={"/setCurrentPlaylist"}>Click here to choose a playlist to modify.</Link> : <p className="text-textColor">In order to modify your playlists with Jammming you need to first connect your Spotify account to the Jammming playlist app.</p>;
